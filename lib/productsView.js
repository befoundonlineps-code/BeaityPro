...
// ⚠️ **و`return_to_supplier` دخلت هنا متأخّرةً بجولةٍ عن مكوّنها**، وذلك بالضبط
// هو العطل: `ReturnToSupplierScreen` بُني ووُصل فرعُه في الصفحة، **والاسمُ لم
// يدخل هذه القائمة** — فبقيت `usesSharedDocumentScreen` صادقةً معه، **ورُسمت
// شاشتان معًا** والقديمةُ فوق الجديدة.
//
// 🔴 **والتعليقُ أعلاه توقّع الاتّجاهَ المعاكس وحدَه** («تسقط من القائمتين فلا
// يرسمها أحد») — **والواقعُ جاء بالاتّجاه الثالث: فرعٌ في الصفحة بلا اسمٍ هنا.**
export const REFERENCE_FORM_VIEWS = ['orders', 'supply', 'write_off', 'return_to_supplier']
