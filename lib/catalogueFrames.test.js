...
describe('the package frame is a fraction, never a floor', () => {
  ...
  it('is a CONVERSION and does not promise to read back', () => {
    ...
    // 28660 across all storages, cell shows 1910.67, and 1910.67 × 15 is
    // 28660.05. (The grain matters and is stated: 28650 of it sits in تجريبي
    // and 10 in العامّ. Quoting the storage figure as the product's is what
    // made this look like ten units appearing from nowhere.)
    //
...
describe('when both frames say the same thing, only one is shown', () => {
  it('drops the package frame for a one-to-one product', () => {
    ...
    // against 28660 across all storages) goes unread.
