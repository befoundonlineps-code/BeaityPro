  ...
  const RAW_NUMBER_INPUTS_ALLOWED = [
    {
      ...
      why: 'خليّةُ جدولٍ بـ`<input>` خامٍ وأصنافٍ خاصّة (`h-8 w-full bg-transparent text-center tabular-nums`). تحويلُها إلى `NumberField` يُدخل أصنافَ `Input` القياسيّة — إطارًا وحوافَّ — فيغيّر شكلَ شبكةٍ لا ضوءَ أخضرَ لإعادة تنسيقها. **مؤجَّلٌ بقرار، لا منسيّ.**',
    },
  ]
