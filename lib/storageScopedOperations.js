...
// OPERATIONS BY WHAT THEY WRITE — which is why `order` sits with the six that
// need a storage even though it is the only one that stays lit at «all
// storages». That sentence is still true and still worth guarding. The heading
// was describing where it happened to be drawn.
//
