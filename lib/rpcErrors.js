...
const RAISED_CODES = {
  ...
  // here: whatever post_stock_document raises about quantities, costs, a
  // negative balance, an archived storage or a frozen consignment product is
  // still unread. Those arrive on screen as "something went wrong" until
  // somebody with a session lists them, and that is the honest state rather
  // than a guessed map that looks complete.
