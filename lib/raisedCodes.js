...
export const RAISED_CODES = {
  ...
  // driven at: post_stock_document and post_stocktake were fetched with
  // pg_get_functiondef. Reading beats driving here — the codes behind the
  ...
  // Their text has not arrived, and this list is a record of what has been
  // SEEN, never completed from the design.
