...
//
// ⚠️ The sentence says that and stops. It used to end with "open the browser
// console (F12) and send the line starting with [db]" — developer instructions
// shown to a receptionist, who does not read them as a task but as an
// admission that the program is broken. Worse than the generic line, which at
// least asks nothing impossible of her.
//
// Harvesting the code never needed her: reportDbError logs every unexpected
// error to the console unconditionally, and isUnexpectedDbError returns true
// for exactly this case — measured in raisedCodes.test.js. Whoever needs the
// code already knows where it is.
