...
const NULL_SAFE_BY_REVIEW = {
  ...
  // not null)`. Safe only if doc_type is NOT NULL, which this repository cannot
  // answer — the diagram lists the column without its nullability. 052c reads
  // information_schema for it. If that comes back YES, this entry is wrong and
  // 044 needs the same fix 052b just took.
