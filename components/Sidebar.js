...
const activeButtonClass = 'flex size-10 items-center justify-center rounded-lg bg-sidebar-primary text-sidebar-primary-foreground'
const disabledButtonClass = 'flex size-10 cursor-not-allowed items-center justify-center rounded-lg text-muted-foreground/50 hover:bg-sidebar-accent'
